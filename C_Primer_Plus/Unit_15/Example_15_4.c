/*
*@FileName:Example_15_4.c
*@Author: Liu Yang
*@Date:  2020/6/6 15:20
*@Email:liuyang__work@163.com
*@Last Modified time: 2020/6/6 15:20
*/
//位字段和按位运算符
#include "stdio.h"
...
struct box_props{
    bool opaque                     : 1;   //或者unsigned int（c99之前）
    unsigned int fill_color         : 3;
    unsigned int                    : 4;
    bool show_border                : 1;  //或者unsigned int（c99之前）
    unsigned int border_color       : 3;
    unsigned int border_style       : 2;
    unsigned int                    : 2;
};

union Views     //把数据看成结构或unsigned short 类型的变量
{
